<%@ Page Title="Facturas" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Facturas.aspx.cs" Inherits="Facturas" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
            ...
            <asp:UpdatePanel runat="server" ID="UpdatePopUp">
                ...
                <div id="fieldProvCust" class="fieldContainer">
                    ...
                    <asp:DropDownList ID="drpProvCust" runat="server" CssClass="lblContainer" AutoPostBack="false"></asp:DropDownList>
                </div>
