...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div style="min-height: 500px;">
        ...
        <div class="container">
            ...
            <asp:TextBox ID="txtDesde" runat="server" CssClass="txtReport dateField" AutoPostBack="false" TextMode="SingleLine"></asp:TextBox>
            <asp:Label ID="lblHasta" runat="server" Text="Hasta:" CssClass="lblReport" Font-Bold="true"></asp:Label>
            <asp:TextBox ID="txtHasta" runat="server" CssClass="txtReport dateField" AutoPostBack="false" TextMode="SingleLine"></asp:TextBox>
        </div>
