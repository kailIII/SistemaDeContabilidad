                ...
                <div id="invoiceFields">
                    ...
                    <div class="coupleFieldContainer">
                        ...
                        <div id="fieldProvCust" class="singleFieldContainer">
                            ...
                            <asp:TextBox ID="txtProv" runat="server" CssClass="txtContainer" onkeydown = "enterPreventDefault(event);"></asp:TextBox>
                            <asp:HiddenField ID="hfProveedorName" runat="server" />
                        </div>
